    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[50vh] overflow-hidden -mt-16 pt-16">
        <div className="absolute inset-0">
          <Image src="/images/degustace/degustace.webp" alt="Degustace" fill className="object-cover" priority sizes="100vw" />
        </div>
          ...
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-5 gap-10 items-start">
              ...
              <div className="md:col-span-2 relative h-[400px] rounded-lg overflow-hidden">
                <Image src="/images/Sklep/sklep1.webp" alt="Řízená degustace" fill className="object-cover rounded-lg" sizes="(max-width: 768px) 100vw, 40vw" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-5 gap-10 items-start">
              <div className="order-2 md:order-1 md:col-span-2 relative h-[400px] rounded-lg overflow-hidden">
                <Image src="/images/Sklep/sklep2.webp" alt="Firemní degustace" fill className="object-cover rounded-lg" sizes="(max-width: 768px) 100vw, 40vw" />
              </div>
            ...
            <div className="grid md:grid-cols-5 gap-10 items-start">
              ...
              <div className="md:col-span-2 relative h-[400px] rounded-lg overflow-hidden">
                <Image src="/images/Sklep/sklep3.webp" alt="Firemní víno" fill className="object-cover rounded-lg" sizes="(max-width: 768px) 100vw, 40vw" />
              </div>
            </div>
          </div>
        </div>
