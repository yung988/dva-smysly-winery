          ...
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-5 gap-10 items-start">
              ...
              <div className="md:col-span-2 relative rounded-lg overflow-hidden" style={{height: 400}}>
                <Image src="/images/Sklep/sklep1.webp" alt="Řízená degustace" width={800} height={400} className="object-cover rounded-lg w-full h-full" quality={60} loading="lazy" decoding="async" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-5 gap-10 items-start">
              <div className="order-2 md:order-1 md:col-span-2 relative rounded-lg overflow-hidden" style={{height: 400}}>
                <Image src="/images/Sklep/sklep2.webp" alt="Firemní degustace" width={800} height={400} className="object-cover rounded-lg w-full h-full" quality={60} loading="lazy" decoding="async" />
              </div>
            ...
            <div className="grid md:grid-cols-5 gap-10 items-start">
              ...
              <div className="md:col-span-2 relative rounded-lg overflow-hidden" style={{height: 400}}>
                <Image src="/images/Sklep/sklep3.webp" alt="Firemní víno" width={800} height={400} className="object-cover rounded-lg w-full h-full" quality={60} loading="lazy" decoding="async" />
              </div>
            </div>
          </div>
        </div>
